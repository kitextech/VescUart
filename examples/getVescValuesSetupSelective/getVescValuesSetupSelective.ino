/*
  Name:    getVescValuesSetupSelective.ino
  Created: 19-08-2018
  Author:  SolidGeek
...
uint32_t mask = 0x000118AE; // this selection mask reflects which values are requested to the VESC
...
void loop() {
  ...
  if ( UART.getVescValuesSelective(mask) ) {
